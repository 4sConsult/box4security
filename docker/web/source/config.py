...
Dashboards = [
    ...
    Dashboard(name='vuln-progress', url='/kibana/app/kibana#/dashboard/f8712020-cefa-11e9-943f-fdbfa2556276?embed=true&_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-90,to:now))', parent_id='#vuln', role='Schwachstellen'),
