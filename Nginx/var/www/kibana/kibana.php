...
<!-- Definition der Rule, mit denen das Dropdown Menü initialisiert werden soll. -->
...
<div class="item" id="administration">
	<div class="ui pointing item">
        <i class="cogs icon"></i> 
 <div class="menu">	
<a class="item" href="administration.php" target="frame"  onclick="setActive('administration','Administration','administration.php')">Administration </a>
</div></div></div>
