...
<div class="ui six column doubling stackable grid container with=300px">
  ...
  <div class="column">
    <p>Source IP</p>
    <div class="ui input">
		<input type="text" placeholder="<?= htmlspecialchars($src_ip, ENT_QUOTES, 'UTF-8'); ?>">
	</div>
  </div>
  <div class="column">
    <p>Source Port</p>
    <div class="ui input">
		<input type="text" placeholder="<?= htmlspecialchars($src_port, ENT_QUOTES, 'UTF-8'); ?>">
	</div>
  </div>
  <div class="column">
    <p>Destination IP</p>
    <div class="ui input">
		<input type="text" placeholder="<?= htmlspecialchars($dest_ip, ENT_QUOTES, 'UTF-8'); ?>">
	</div>
  </div>
  <div class="column">
    <p>Destination Port</p>
    <div class="ui input">
		<input type="text" placeholder="<?= htmlspecialchars($dest_port, ENT_QUOTES, 'UTF-8'); ?>">
	</div>
  </div>
  <div class="column">
    <p>Protocol</p>
	<div class="ui right labeled input">
	<input type="text" placeholder="<?= htmlspecialchars($proto, ENT_QUOTES, 'UTF-8'); ?>">
  <div class="ui dropdown label">
    <div class="text"><?= htmlspecialchars($proto, ENT_QUOTES, 'UTF-8'); ?></div>
