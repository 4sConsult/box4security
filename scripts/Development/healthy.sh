...
CONTAINERS_WITH_HEALTHCHECK=(elasticsearch nginx logstash kibana web wazuh db openvas suricata)
...
do
    ...
    /home/amadmin/box4s/scripts/System_Scripts/wait-for-healthy-container.sh $name
done
stay_healthy
